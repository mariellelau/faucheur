...
class CampagneController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $campagnes = $em->getRepository('FaucheurBundle:Campagne')->findAll();

        return $this->render('@Faucheur/campagne/index.html.twig', array(
            'campagnes' => $campagnes,
        ));
    }
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('FaucheurBundle\Form\CampagneType', $campagne);
        ...
        return $this->render('@Faucheur/campagne/new.html.twig', array(
            'campagne' => $campagne,
    ...
    public function showAction(Campagne $campagne)
    {
        ...
        return $this->render('@Faucheur/campagne/show.html.twig', array(
            'campagne' => $campagne,
    ...
    {
        $deleteForm = $this->createDeleteForm($campagne);
        $editForm = $this->createForm('FaucheurBundle\Form\CampagneType', $campagne);
        ...
        return $this->render('@Faucheur/campagne/edit.html.twig', array(
            'campagne' => $campagne,
