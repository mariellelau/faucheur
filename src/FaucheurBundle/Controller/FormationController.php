...
use FaucheurBundle\Entity\Formation;
...
class FormationController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $formations = $em->getRepository('FaucheurBundle:Formation')->findAll();

        return $this->render('@Faucheur/formation/index.html.twig', array(
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('FaucheurBundle\Form\FormationType', $formation);
        ...
        return $this->render('@Faucheur/formation/new.html.twig', array(
            'formation' => $formation,
    ...
    {
        $deleteForm = $this->createDeleteForm($formation);
        $editForm = $this->createForm('FaucheurBundle\Form\FormationsType', $formation);
        ...
        return $this->render('@Faucheur/formation/edit.html.twig', array(
            'formation' => $formation,
