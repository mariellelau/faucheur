...
use FaucheurBundle\Entity\Action;
...
class ActionController extends Controller
{
    ...
    {
        $action = new Action();
        $form = $this->createForm('FaucheurBundle\Form\ActionType', $action);
    ...
    {
        $deleteForm = $this->createDeleteForm($action);
        $editForm = $this->createForm('FaucheurBundle\Form\ActionType', $action);
